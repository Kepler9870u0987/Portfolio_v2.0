...
export const AboutStory: React.FC = () => {
  return (
    <section id={SectionId.ABOUT} className="py-24 bg-slate-950/30 backdrop-blur-sm relative overflow-hidden scroll-mt-20">
            ...
            <div className="pt-6 border-t border-slate-800/50 flex flex-wrap gap-8">
              <div className="flex flex-col">
                <span className="flex items-center gap-2 text-3xl font-bold text-white">
                  <Building2 className="text-accent-500" size={28} /> Fintech
                </span>
                <span className="text-sm text-slate-500 uppercase tracking-wider">Esperienza</span>
              </div>
              <div className="flex flex-col">
                <span className="flex items-center gap-2 text-3xl font-bold text-white">
                  <ShieldCheck className="text-green-500" size={28} /> Enterprise
                </span>
                <span className="text-sm text-slate-500 uppercase tracking-wider">Methodology</span>
              </div>
            </div>
             <div className="mt-4">
                 <a href="https://www.linkedin.com/in/manuel-albanese" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-accent-400 hover:text-accent-300 transition-colors border-b border-transparent hover:border-accent-400">
                    Verifica il mio percorso su LinkedIn <TrendingUp size={16} />
                 </a>
              </div>
          </div>
          ...
          <div className="lg:w-1/2 w-full">
            <div className="relative border-l-2 border-slate-800 ml-4 md:ml-8 space-y-12 py-4">
              ...
              <div className="relative pl-8 md:pl-12 group">
                <div className="absolute -left-[9px] md:-left-[9px] top-0 w-4 h-4 rounded-full bg-slate-800 border-2 border-slate-600 group-hover:bg-accent-500 group-hover:border-accent-400 transition-colors"></div>
              ...
              <div className="relative pl-8 md:pl-12 group">
                <div className="absolute -left-[9px] md:-left-[9px] top-0 w-4 h-4 rounded-full bg-accent-500 border-2 border-accent-300 shadow-[0_0_15px_rgba(99,102,241,0.5)]"></div>
                <div className="flex items-center gap-4 mb-2">
